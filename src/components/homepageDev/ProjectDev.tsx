const projects = [
  {
    ...
    desc: 'Simple physics simulations to help the general public get an insight into physics. CHANGE THIS',
    demo: 'link',
    repo: 'link',
    status: true
  },
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="mr-4 flex items-center gap-2 opacity-70 group-hover:opacity-100">
              ...
              >
                ...
                <span className="hidden w-0 overflow-hidden transition-[width] duration-500 ease-in-out hover:text-white hover:underline group-hover:w-10 [@media(min-width:355px)]:block">
                  repo
                </span>
              </a>
            </div>
          </div>
          <div className="s:flex-nowrap flex flex-wrap items-center justify-between gap-3 text-xs font-extralight opacity-70">
            <p className="s:w-[45ch] mb-auto mt-1 w-full">{project.desc}</p>
          </div>
        </article>
      ))}
    </div>
